...
public enum ErrorCode {
    ...
    // ── Invoice ─────────────────────────────────────────────────────────
    INVOICE_NOT_EXISTED  (5001, "Invoice not found",                HttpStatus.NOT_FOUND),
    INVOICE_ALREADY_PAID (5002, "Invoice has already been paid",    HttpStatus.CONFLICT),
    INVOICE_ALREADY_EXISTS(5003, "Invoice already exists for this booking", HttpStatus.CONFLICT),

    // ── Payment ────────────────────────────────────────────────────────
    PAYMENT_METHOD_NOT_EXISTED(5010, "Payment method not found",            HttpStatus.NOT_FOUND),
    PAYMENT_PROCESSING_ERROR  (5011, "Payment processing error",             HttpStatus.INTERNAL_SERVER_ERROR),
    PAYMENT_SIGNATURE_INVALID (5012, "Payment signature verification failed",HttpStatus.BAD_REQUEST);
